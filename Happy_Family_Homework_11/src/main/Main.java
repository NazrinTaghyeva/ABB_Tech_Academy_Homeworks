...
//      Pet pet = new Pet(AnimalSpeciesEnum.DOG,"Cookie",2,84, new String[]{"eating","playing"});
        ...
        family01 = familyController.createNewFamily(mother, father);
        ...
        Date year = null;
        try {
            year = f.parse("15 07 2022");
        } catch (ParseException e) {
            e.printStackTrace();
        }

        System.out.println("Age " + father.describeAge(today, year));
